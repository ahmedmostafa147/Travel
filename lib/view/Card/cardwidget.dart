              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    PaymentCard(
                        imageUrl: mastercardImageUrl, cardName: 'Mastercard'),
                  ],
                ),
              ),
              SizedBox(
...
class _PaymentInfoScreenState extends State<PaymentInfoScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(BookTicketController());
    final wayController = SelectWayController.instance;
    return Padding(
              ...
              isLoading
                  ...
                  : CustomMaterialButton(
                      ...
                      onPressed: () async {
                        ...
                        await controller.bookNow(wayController.selectedWay,
                            wayController.numberOfGuests);
                      }),
              // CustomMaterialButton(
              //     buttonText: "Pay Now",
              //     onPressed: () {
